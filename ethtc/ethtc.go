...
// Withdraw is a paid mutator transaction binding the contract method 0x4570056d.
//
// Solidity: function withdraw(uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[1] input, bytes32 _root, bytes32 _nullifierHash, address _recipient, address _relayer, uint256 _fee, uint256 _refund) payable returns()
func (_Ethtc *EthtcTransactor) Withdraw(opts *bind.TransactOpts, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [1]*big.Int, _root [32]byte, _nullifierHash [32]byte, _recipient common.Address, _relayer common.Address, _fee *big.Int, _refund *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function withdraw(uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[1] input, bytes32 _root, bytes32 _nullifierHash, address _recipient, address _relayer, uint256 _fee, uint256 _refund) payable returns()
func (_Ethtc *EthtcSession) Withdraw(a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [1]*big.Int, _root [32]byte, _nullifierHash [32]byte, _recipient common.Address, _relayer common.Address, _fee *big.Int, _refund *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function withdraw(uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[1] input, bytes32 _root, bytes32 _nullifierHash, address _recipient, address _relayer, uint256 _fee, uint256 _refund) payable returns()
func (_Ethtc *EthtcTransactorSession) Withdraw(a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [1]*big.Int, _root [32]byte, _nullifierHash [32]byte, _recipient common.Address, _relayer common.Address, _fee *big.Int, _refund *big.Int) (*types.Transaction, error) {
	return _Ethtc.Contract.Withdraw(&_Ethtc.TransactOpts, a, b, c, input, _root, _nullifierHash, _recipient, _relayer, _fee, _refund)
}
